...
#define IB(id)    (I[(id)])
#define IW(id)    (*(WORD*)&I[(id)])
#define ID(id)    (*(DWORD*)&I[(id)])
#define IL(id)    (*(LWORD*)&I[(id)])

#define QX(id)    ((Q[(id) >> 3] >> ((id) & 0x07)) & 0x01)
#define QB(id)    (Q[(id)])
#define QW(id)    (*(WORD*)&Q[(id)])
#define QD(id)    (*(DWORD*)&Q[(id)])
#define QL(id)    (*(LWORD*)&Q[(id)])

#define MX(id)    ((M[(id) >> 3] >> ((id) & 0x07)) & 0x01)
#define MB(id)    (M[(id)])
#define MW(id)    (*(WORD*)&M[(id)])
#define MD(id)    (*(DWORD*)&M[(id)])
#define ML(id)    (*(LWORD*)&M[(id)])

#define IX_ADDR(id)    ((BOOL*)&I[(id) >> 3])
#define IB_ADDR(id)    ((BYTE*)&I[(id)])
#define IW_ADDR(id)    ((WORD*)&I[(id)])
#define ID_ADDR(id)    ((DWORD*)&I[(id)])
#define IL_ADDR(id)    ((LWORD*)&I[(id)])

#define QX_ADDR(id)    ((BOOL*)&Q[(id) >> 3])
#define QB_ADDR(id)    ((BYTE*)&Q[(id)])
#define QW_ADDR(id)    ((WORD*)&Q[(id)])
#define QD_ADDR(id)    ((DWORD*)&Q[(id)])
#define QL_ADDR(id)    ((LWORD*)&Q[(id)])

#define MX_ADDR(id)    ((BOOL*)&M[(id) >> 3])
#define MB_ADDR(id)    ((BYTE*)&M[(id)])
#define MW_ADDR(id)    ((WORD*)&M[(id)])
#define MD_ADDR(id)    ((DWORD*)&M[(id)])
#define ML_ADDR(id)    ((LWORD*)&M[(id)])
